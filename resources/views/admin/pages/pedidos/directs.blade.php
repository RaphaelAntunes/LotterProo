...
<div class="row  p-3">
    <div class="col-md-12">
        <div class="col-md-12 p-4 card-header">
            <h3 class="text-center text-bold">Directs</h3>
        </div>
        <div class="container">

            <div class="d-flex justify-content-center align-items-center card-header container">
                <input class="form-control" type="text" name="" id=""> <select class="form-control">
                    <option class="bg-light" value="5">5 Registros</option>
                    <option class="bg-light" value="10">10 Registros</option>
                    <option class="bg-light" value="25">25 Registros</option>
                    <option class="bg-light" value="50">50 Registros</option>
                    <option class="bg-light" value="100">100 Registros</option>
                </select>
            </div>
